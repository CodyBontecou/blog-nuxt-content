...
S: My friend, my wife and I were camping in my vintage RV outside of a hot spring in the mountains of California, when it came time to leave our RV would not start. I felt really sorry for bringing my friend and wife here and putting them into a difficult position.

T: We were pretty far from the path so it would be very difficult to get the vehicle towed, staying another night wasn't an option because I have this interview today and my friend had to work, so our only options were to get the car towed somehow or get the car running.

A: I took a systematic approach and decided to go down the list of what could be possible broken, so first we checked the battery and got it jumped start, and the car still didn't start, then we added gasoline and verify that the fuel pump and fuel system was working, and then we verified that the vehicle had spark.

R: It turns out it required a jump start and adding gasoline to get the motor running and we were able to get out find and make it to our destination.
...
3. Tell me about a time when you took it upon yourself to work on a challenging initiative.
...
5. Tell me about a time when you took on a task that went beyond your normal responsibilities.

S: I got very involved with recruitment in my previous company helping with the interview process for new candidates. It was completley voluntary and something i requested to be a part of to help.

T:  I lead the type-script and javascript interviews processs coming up with creative and technical questions that had to be flexible and match the candidate skills.

A: I interviewed several prospected candidates and learn from each interview for future candidated so they would be givien and enjoyable interview experience.

R: Succesfully brought on a few developers that became the companies best type script developers.
...
1. Tell me about a time when you changed a process at work through either an innovative new way or simplification.
